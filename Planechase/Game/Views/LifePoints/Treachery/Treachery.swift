...
class TreacheryData: ObservableObject {
    ...
    init() {
        leaders = iniLeaders()
        guardians = iniGuardians()
        assassins = iniAssassins()
        traitors = iniTraitors()
    }
    
    private func iniLeaders() -> [TreacheryRoleData] {
        return [
    ...
    private func iniGuardians() -> [TreacheryRoleData] {
        return [
    ...
    private func iniAssassins() -> [TreacheryRoleData] {
        return [
    ...
    private func iniTraitors() -> [TreacheryRoleData] {
        return [
