...
extension IAPManager {
    ...
    func price(/*forProduct productKey: String*/) -> String? {
        let currencyFormatter = NumberFormatter()
        guard let skProduct = products?.first else { return nil }
        //guard let skProduct = products[productKey] else { return nil }
...
extension IAPManager {
    static func getSharedSecret() -> String {
        return  "32b8a9ff18274ee191b56f8fa8babef8"
    }
